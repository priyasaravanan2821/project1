...
X= data.drop(labels = ["Target","Age (yrs)","Weight (Kg)","Height(Cm)","BMI","RR (breaths/min)","Blood Group","Cycle(R/I)","Cycle length(days)","Marraige Status (Yrs)","Pregnant(Y/N)","No. of aborptions","Hip(inch)","Waist(inch)","Waist:Hip Ratio","Weight gain(Y/N)","hair growth(Y/N)","Skin darkening (Y/N)","Hair loss(Y/N)","Pimples(Y/N)","Fast food (Y/N)","Reg.Exercise(Y/N)","Follicle No. (L)","Follicle No. (R)","Avg. F size (L) (mm)","Avg. F size (R) (mm)","Endometrium (mm)"],axis = 1)
y=data.Target
...
pickle.dump(rf, open('model log_rf_prof.pkl','wb'))
